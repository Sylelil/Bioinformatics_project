...
def concatenate(path_to_save, dataset_name, lookup_dir_tiles_train=None, lookup_dir_tiles_val=None, lookup_dir_tiles_test=None,
                lookup_dir_genes_train=None, lookup_dir_genes_val=None, lookup_dir_genes_test=None, n_components=None, scaler=None, ipca=None,
                with_ipca=False):
    """
       Description: Concatenate gene features (possibly copied according to specified ratio) with tile features.
       :param lookup_dir_tiles: lookup directory with tile features
