...
def main():
    ...
    a_normal_genes = anderson_normality_test(df_0, df_1)

    # Shapiro test
    print("\n[DGEA pre-processing] Shapiro test:")
    s_normal_genes = shapiro_normality_test(df_0, df_1, alpha)

    # Normal test
    print("\n[DGEA pre-processing] Normal test:")
    n_normal_genes = normal_test(df_0, df_1, alpha)
    ...
    alpha = 0.05
    w_reduced_genes = welch_t_test(df_0, df_1, alpha)
    ...
    X_train_0, X_test_0, y_train_0, y_test_0 = train_test_split(df_reduced_0, df_reduced_0.index,
                                                                test_size=0.2, random_state=0)
    X_train_1, X_test_1, y_train_1, y_test_1 = train_test_split(df_reduced_1, df_reduced_1.index,
                                                                test_size=0.2, random_state=0)
